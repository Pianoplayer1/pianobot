...
class Vote(commands.Cog):
    ...
    async def vote(self, ctx: commands.Context):
        ...
        first_msg: Message = await ctx.send('Please wait until I have posted every vote before you start voting, I will notify you once you can vote.')
...
Start voting at the top by clicking here: {first_msg.jump_url}'''
    ...
    async def send(self, ctx: commands.Context, member: dict):
