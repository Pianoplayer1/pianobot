...
class Members(commands.Cog):
    ...
    async def members(self, ctx, *, args = None):
        ...
        for member in eden.members:
            ...
            if any(role in high_roles for role in member.roles):
            ...
            if roles['guild_member'] in member.roles:
                ...
                if highest_role != roles[ingame_rank]:
                    output['Highest Discord role not matching ingame role'].append(message_name + ' (' + ingame_rank.capitalize() + ' ingame)')
